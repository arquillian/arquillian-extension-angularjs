...
public interface AngularActionSearchContext {

    List<WebElement> findElements(String action);

    List<WebElement> findElementsInElement(String action, WebElement context);
}
